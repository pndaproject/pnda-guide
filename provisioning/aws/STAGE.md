...
See [these tips](https://github.com/pndaproject/pnda-guide/blob/develop/provisioning/aws/EXAMPLES.md) for rapidly creating an HTTP server using a number of different approaches.
